...
export default class Form extends Component {
  ...
  getRegistry() {
    ...
    return {
      ...
      AddButtonTemplate: this.props.AddButtonTemplate,
      RemoveButtonTemplate: this.props.RemoveButtonTemplate,
      MoveUpButtonTemplate: this.props.MoveUpButtonTemplate,
      MoveDownButtonTemplate: this.props.MoveDownButtonTemplate,
